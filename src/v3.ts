export const v3 = {
  "productName": "Local Presence Auditor",
  "productTier": "release",
  ...
  "capabilities": [
    "Domain-specific workbench: Local Presence Audit Console",
    "Operational table: Audit findings",
  ...
  "releaseChecklist": [
    ...
    "Presence Score reaches production threshold",
    "Impact/Effort Priority is documented with evidence",
    "Evidence Coverage has no unresolved blocker",
    "Owner-safe audit report verified",
    "Impact-effort roadmap verified",
    "CSV findings ledger verified"
  ],
  "operations": [
