...
**Local Presence Auditor** is a polished, local-first open-source tool from Volta's open-source program. It helps Volta student pods auditing restaurants, service businesses, and nonprofits before kickoff turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
