//! Rust release-gate engine for Local Presence Auditor.
//!
...
pub const PRODUCT_SLUG: &str = "local-presence-auditor";
pub const PRODUCT_TITLE: &str = "Local Presence Auditor";
